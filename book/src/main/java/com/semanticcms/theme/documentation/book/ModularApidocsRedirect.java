...
package com.semanticcms.theme.documentation.book;
...
@WebServlet("/theme-documentation/apidocs/com/*")
public class ModularApidocsRedirect extends HttpServlet {
  ...
  protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
    HttpServletUtil.sendRedirect(
      ...
      "/theme-documentation/apidocs/com.semanticcms.theme.documentation/com" + Objects.toString(req.getPathInfo(), ""),
